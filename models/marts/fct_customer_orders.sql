...
paid_orders as (select orders.order_id,
        ...
        orders.order_status,
        successful_payment.total_amount_paid,
        successful_payment.payment_finalized_date,
        customers.customer_first_name,
        customers.customer_last_name
    FROM orders
    left join  successful_payment ON orders.order_id = successful_payment.order_id
